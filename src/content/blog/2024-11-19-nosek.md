...
It would be great to drop this and not write about it ever again. But here's the rub: We were asked by the editors to summarize the reason for retraction in our matters arising, and in misrepresenting why the paper was retracted the authors are publicly claiming my published work is incorrect. Here it is on display in _Nature_

![sciencehardpng.png](/assets/img/sciencehardpng.png)

Here, Nosek attributes the findings of the investigation to _us_. The investigation involved four domain experts, several editors, and a whole bunch of higher-ups in Springer Nature (as is policy). The result is that a very well known scientist is publicly asserting my work isn't robust.
...
![expertpredict.png](/assets/img/expertpredict.png)
...
![originalpurpose.png](/assets/img/originalpurpose.png)
...
Fortunately, I didn't rely on vibes when raising these concerns. Instead, I just looked at the documents they shared. Tal Yarkoni, in his review at _Nature_ sensed the outcome switch, noting:
...
This makes it clear that in the version reviewed and rejected at _Nature_ the authors had transparency issues surrounding clear design choices intended to test supernatural effects. Yarkoni sensed it, likely knowing Schooler's past work, and asked the authors to be honest about it.
...
![lakensdecline.png](/assets/img/lakensdecline.png)

Here's the author's response to Yarkoni:

![reviewerresponsedecline.png](/assets/img/reviewerresponsedecline.png)
...
![declinecollage.png](/assets/img/declinecollage.png)
...
![howdidithappen.png](/assets/img/howdidithappen.png)

I'll assume Brian hasn't looked at the documentation they added, because we know exactly how this happened and why.

The version submitted to _Nature_ did not have a link to the decline effects preregistration, and did not indicate everything was preregistered. Yarkoni noted this seemed strange, given the overall focus of the paper.

![preregcommentreview.png](/assets/img/preregcommentreview.png)

So how did that pesky line get added? Well, in the revision for resubmission it was added by John Protzko.

![protzkoeditprereg.png](/assets/img/protzkoeditprereg.png)
...
Against this backdrop, when asked explicitly by reviewers if _these analyses were preregistered_, this line was added. When they were asked by two reviewers to clarify if they had intended to study a supernatural phenomena---they removed virtually all references to the original hypothesis and its motivations.
